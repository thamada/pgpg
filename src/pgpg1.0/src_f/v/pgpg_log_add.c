     ...
     struct vhdl_description *vd;
{
  ...
  if(iflag==0){
    ...
    sprintf((*vd).sde[ie], "-- *  VERSION: 1.02                                              * \n" );ie++;
    sprintf((*vd).sde[ie], "-- *  LAST MODIFIED AT Fri Jul 12 09:00:01 JST 2002              * \n" );ie++;
    sprintf((*vd).sde[ie], "-- *************************************************************** \n" );ie++;
    ...
    sprintf((*vd).sde[ie], "\n\n");ie++;
    sprintf((*vd).sde[ie], "  ---------------------||/|/|/|/|/|/|/|/|/|/|/ \n");ie++;
    sprintf((*vd).sde[ie], "  -- PIPELINE (NP>1)   |/|/|/|/|/|/|/|/|/|/|/| \n" );ie++;
    sprintf((*vd).sde[ie], "  ---------------------/|/|/|/|/|/|/|/|/|/|/|| \n");ie++;
    if(nstage>1){
    ...
    sprintf((*vd).sde[ie], "\n\n");ie++;
    sprintf((*vd).sde[ie], "  ---------------------||/|/|/|/|/|/|/|/|/|/|/ \n");ie++;
    sprintf((*vd).sde[ie], "  -- PIPELINE (NP>=3)  |/|/|/|/|/|/|/|/|/|/|/| \n" );ie++;
    sprintf((*vd).sde[ie], "  ---------------------/|/|/|/|/|/|/|/|/|/|/|| \n");ie++;
    sprintf((*vd).sde[ie], "\n");ie++;
    if(nstage>=3){
      sprintf((*vd).sde[ie], "  process(clock) begin                                             \n" );ie++;
    ...
    {
      char _allhigh[1000][STRLEN];
      char _alllow[1000][STRLEN];
      int _ilen;
    ...
    sprintf((*vd).sde[ie], "\n\n");ie++;
    sprintf((*vd).sde[ie], "  ---------------------||/|/|/|/|/|/|/|/|/|/|/ \n");ie++;
    sprintf((*vd).sde[ie], "  -- PIPELINE (NP==4)  |/|/|/|/|/|/|/|/|/|/|/| \n" );ie++;
    sprintf((*vd).sde[ie], "  ---------------------/|/|/|/|/|/|/|/|/|/|/|| \n");ie++;
    sprintf((*vd).sde[ie], "\n");ie++;
    if(nstage==4){
      sprintf((*vd).sde[ie], "  process(clock) begin                                             \n" );ie++;
