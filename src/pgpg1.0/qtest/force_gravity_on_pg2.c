...
{                                                                   
  ...
  for(i=0;i<n;i+=npipe){                                              
    ...
    for(ii=0;ii<nn;ii++){                                             
      xi = ((unsigned int) ((x[i+ii][0] + ((4.0)/2.0)) * (pow(2.0,20.0)/(4.0)) + 0.5)) & 0xffffffff;
      yi = ((unsigned int) ((x[i+ii][1] + ((4.0)/2.0)) * (pow(2.0,20.0)/(4.0)) + 0.5)) & 0xffffffff;
      zi = ((unsigned int) ((x[i+ii][2] + ((4.0)/2.0)) * (pow(2.0,20.0)/(4.0)) + 0.5)) & 0xffffffff;
      if(eps2 == 0.0){                                         
        ieps2 = 0;                                                
      }else if(eps2 > 0.0){                                    
    ...
    for(ii=0;ii<nn;ii++){                                           
      ...
      a[i+ii][0] = ((double)(sx<<0))*(-(pow(2.0,20.0)/(4.0))*(pow(2.0,20.0)/(4.0))/(pow(2.0,60.0)/(1.0/1024.0)))/pow(2.0,0.0);
      a[i+ii][1] = ((double)(sy<<0))*(-(pow(2.0,20.0)/(4.0))*(pow(2.0,20.0)/(4.0))/(pow(2.0,60.0)/(1.0/1024.0)))/pow(2.0,0.0);
      a[i+ii][2] = ((double)(sz<<0))*(-(pow(2.0,20.0)/(4.0))*(pow(2.0,20.0)/(4.0))/(pow(2.0,60.0)/(1.0/1024.0)))/pow(2.0,0.0);
    }                                                               
